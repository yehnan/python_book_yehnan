...
def base26encode(number, width=0): 
    result = []
    while number-1 >= base:
    ...
    # padding
    result.extend([alphabet[0]] * (width - len(result)))
...
print('------')
print('at ', base26decode('at'))
print(base26encode(base26decode('at') + 1, 2))
print('bzz ', base26decode('bzz'))
print(base26encode(base26decode('bzz') + 1, 4))
print('zz ', base26decode('zz'))
print(base26encode(base26decode('zz') + 1, 4))
print('-' * 40)
